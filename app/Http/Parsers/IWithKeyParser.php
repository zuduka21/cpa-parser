...
interface IWithKeyParser
{
     ...
     * @return array()
     */
    function getInfo($key, $get_brand,$report_name, $shift_date, $finish_date);
    /**
     * A function that returns a api-key in exchange for a password and a user login
     *
     * @param  string  $login
     * @param  string  $password
     * @return string
     */
    function getApiKey($login, $password);
}